  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div>
          <Link href="/" className="inline-flex items-center text-sm text-text-secondary hover:text-primary mb-2">
            <ArrowLeft className="h-4 w-4 mr-1" />
            Back to Store
          </Link>
          <h1 className="text-heading-1 text-text-primary">Admin Dashboard</h1>
          <p className="text-text-secondary">Manage your products and inventory</p>
        </div>
