...
export default function CheckoutPage() {
  ...
  // Generated once when this page mounts and reused for every submit
  // attempt from this visit (including a double-click or a retry after a
  // dropped connection) — the server uses this to recognize "the same
  // checkout attempt" and return the original order instead of creating a
  // duplicate. A fresh key is only generated by navigating to /checkout
  // again, which only happens for a genuinely new checkout.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (submitting) return; // belt-and-suspenders alongside the disabled button below
    setError("");
    setSubmitting(true);
